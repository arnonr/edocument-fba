...
/***/ "./resources/js/src/views/email-group/emailGroupStoreModule.js":
/*!*********************************************************************!*\
  !*** ./resources/js/src/views/email-group/emailGroupStoreModule.js ***!
  \*********************************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  actions: {
    ...
    fetchEmailGroup: function fetchEmailGroup(ctx, _ref) {
      var id = _ref.id;
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/email/group/".concat(id)).then(function (response) {
          return resolve(response);
        })["catch"](function (error) {
          return reject(error);
        });
    ...
    addEmailGroup: function addEmailGroup(ctx, emailGroupData) {
      ...
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/email/group", form_data, {
          headers: {
    ...
    editEmailGroup: function editEmailGroup(ctx, emailGroupData) {
      var form_data = new FormData();
    ...
    deleteEmailGroup: function deleteEmailGroup(ctx, _ref2) {
      var id = _ref2.id;
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_2__["default"]["delete"]("/email/group/".concat(id)).then(function (response) {
          return resolve(response);
        })["catch"](function (error) {
          return reject(error);
        });
