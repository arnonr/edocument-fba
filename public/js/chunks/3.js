...
/***/ "./resources/js/src/views/book-in/bookInStoreModule.js":
/*!*************************************************************!*\
  !*** ./resources/js/src/views/book-in/bookInStoreModule.js ***!
  \*************************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  mutations: {},
  actions: {
    fetchBookIns: function fetchBookIns(ctx) {
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/bookIn").then(function (response) {
    ...
    fetchBookInsWithYear: function fetchBookInsWithYear(ctx, _ref) {
      ...
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/bookIn/getWithYear/".concat(yearID)).then(function (response) {
          return resolve(response);
        })["catch"](function (error) {
          return reject(error);
        });
    ...
    fetchBookIn: function fetchBookIn(ctx, _ref2) {
      var id = _ref2.id;
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/bookIn/".concat(id)).then(function (response) {
          return resolve(response);
        })["catch"](function (error) {
          return reject(error);
        });
    ...
    fetchCategories: function fetchCategories(ctx) {
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/category").then(function (response) {
          return resolve(response);
        })["catch"](function (error) {
          return reject(error);
        });
    ...
    fetchBookCodeOld: function fetchBookCodeOld(ctx, _ref3) {
      var yearID = _ref3.yearID;
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/bookCode/old/".concat(yearID)).then(function (response) {
          return resolve(response);
        })["catch"](function (error) {
          return reject(error);
        });
    ...
    addBookIn: function addBookIn(ctx, bookInData) {
      ...
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/bookIn", form_data, {
          headers: {
    ...
    editBookIn: function editBookIn(ctx, bookInData) {
      var form_data = new FormData();
    ...
    deleteBookIn: function deleteBookIn(ctx, _ref4) {
      var id = _ref4.id;
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_2__["default"]["delete"]("/bookIn/".concat(id)).then(function (response) {
          return resolve(response);
        })["catch"](function (error) {
          return reject(error);
        });
    ...
    addBookFavorite: function addBookFavorite(ctx, bookFavoriteData) {
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/bookFavorite/", bookFavoriteData).then(function (response) {
          return resolve(response);
        })["catch"](function (error) {
          return reject(error);
        });
    ...
    deleteBookFavorite: function deleteBookFavorite(ctx, bookFavoriteData) {
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/bookFavorite/delete/", bookFavoriteData).then(function (response) {
          return resolve(response);
        })["catch"](function (error) {
          return reject(error);
        });
