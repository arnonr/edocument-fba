...
/***/ "./resources/js/src/views/book-out/bookOutStoreModule.js":
/*!***************************************************************!*\
  !*** ./resources/js/src/views/book-out/bookOutStoreModule.js ***!
  \***************************************************************/
/*! exports provided: default */
  ...
  actions: {
    fetchUsers: function fetchUsers(ctx) {
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/users").then(function (response) {
    ...
    fetchBookOuts: function fetchBookOuts(ctx) {
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/bookOut").then(function (response) {
          return resolve(response);
        })["catch"](function (error) {
          return reject(error);
        });
    ...
    fetchBookOutsWithYear: function fetchBookOutsWithYear(ctx, _ref) {
      var yearID = _ref.yearID;
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/bookOut/getWithYear/".concat(yearID)).then(function (response) {
          return resolve(response);
        })["catch"](function (error) {
          return reject(error);
        });
    ...
    fetchBookOut: function fetchBookOut(ctx, _ref2) {
      var id = _ref2.id;
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/bookOut/".concat(id)).then(function (response) {
          return resolve(response);
        })["catch"](function (error) {
          return reject(error);
        });
    ...
    fetchBookTypes: function fetchBookTypes(ctx) {
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/bookType").then(function (response) {
          return resolve(response);
        })["catch"](function (error) {
          return reject(error);
        });
    ...
    fetchBookTypesYear: function fetchBookTypesYear(ctx, _ref3) {
      var yearID = _ref3.yearID;
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/bookType", {
          params: {
            yearID: 1
          }
    ...
    fetchDepartments: function fetchDepartments(ctx) {
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/department").then(function (response) {
          return resolve(response);
        })["catch"](function (error) {
          return reject(error);
        });
    ...
    fetchBookStatus: function fetchBookStatus(ctx) {
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/bookStatus").then(function (response) {
          return resolve(response);
        })["catch"](function (error) {
          return reject(error);
        });
    ...
    fetchEmailPersons: function fetchEmailPersons(ctx) {
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/email/person").then(function (response) {
          return resolve(response);
        })["catch"](function (error) {
          return reject(error);
        });
    ...
    fetchEmailGroups: function fetchEmailGroups(ctx) {
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/email/group").then(function (response) {
          return resolve(response);
        })["catch"](function (error) {
          return reject(error);
        });
    ...
    fetchBookCode: function fetchBookCode(ctx) {
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/bookCode").then(function (response) {
          return resolve(response);
        })["catch"](function (error) {
          return reject(error);
        });
    ...
    addBookOut: function addBookOut(ctx, bookInData) {
      ...
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/bookOut", form_data, {
          headers: {
    ...
    editBookOut: function editBookOut(ctx, bookInData) {
      var form_data = new FormData();
    ...
    deleteBookOut: function deleteBookOut(ctx, _ref4) {
      var id = _ref4.id;
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_2__["default"]["delete"]("/bookOut/".concat(id)).then(function (response) {
          return resolve(response);
        })["catch"](function (error) {
          return reject(error);
        });
    ...
    addBookOutFavorite: function addBookOutFavorite(ctx, bookOutFavoriteData) {
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/bookOutFavorite/", bookOutFavoriteData).then(function (response) {
          return resolve(response);
        })["catch"](function (error) {
          return reject(error);
        });
    ...
    deleteBookOutFavorite: function deleteBookOutFavorite(ctx, bookOutFavoriteData) {
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_2__["default"].post("/bookOutFavorite/delete/", bookOutFavoriteData).then(function (response) {
          return resolve(response);
        })["catch"](function (error) {
          return reject(error);
        });
    ...
    changeBookOutStatus: function changeBookOutStatus(ctx, bookOutData) {
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_2__["default"].put("/bookOut/changeStatus", bookOutData).then(function (response) {
          return resolve(response);
        })["catch"](function (error) {
          return reject(error);
        });
    ...
    fetchYears: function fetchYears(ctx) {
      return new Promise(function (resolve, reject) {
        _axios__WEBPACK_IMPORTED_MODULE_2__["default"].get("/bookYear").then(function (response) {
          return resolve(response);
        })["catch"](function (error) {
          return reject(error);
        });
