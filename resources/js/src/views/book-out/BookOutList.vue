<template>
    <div>
        ...
        <div>
            <b-row>
                <b-col md="3">
                    <b-card class="bg-info text-white">
                        <b-card-title
                            ><h4 class="text-white">
                                รอสารบรรณรับเรื่อง
                            </h4></b-card-title
                        ...
                        <b-card-text style="float: right">
                            {{ statusCount.status1 }} เอกสาร</b-card-text
                        >
                    </b-card>
                </b-col>
                <b-col md="3">
                    <b-card class="bg-primary text-white">
                        ...
                        >
                        <b-card-text style="float: right">
                            {{ statusCount.status2 }} เอกสาร
                        </b-card-text>
                    </b-card>
                </b-col>
                <b-col md="3">
                    <b-card class="bg-warning text-white">
                        <b-card-title
                            ><h4 class="text-white">
                                อนุมัติเรียบร้อย
                            </h4></b-card-title
                        >
                        <b-card-text style="float: right">
                            {{ statusCount.status3 }} เอกสาร</b-card-text
                        >
                    </b-card>
                </b-col>
                <b-col md="3">
                    <b-card class="bg-success text-white">
                        <b-card-title
                            ><h4 class="text-white">เสร็จสิ้น</h4></b-card-title
                        >
                        <b-card-text style="float: right">
                            {{ statusCount.status4 }} เอกสาร</b-card-text
                        >
                    </b-card>
                </b-col>
            </b-row>
            ...
            <b-row>
                <b-col cols="12" md="12">
                    <b-button
                        variant="success"
                        class="mb-sm-0 mr-0"
                        @click="$router.push({ name: 'bookout-add' })"
                        :block="
                    ...
                    <b-button
                        ...
                        class="mb-sm-0 mr-0"
                        style="float:right;"
                        @click="$router.push({ name: 'bookout-old' })"
                        :block="
                            $store.getters['app/currentBreakPoint'] === 'xs'
                        "
                    >
...
import useBookOutList from "./useBookOutList";
...
export default {
    ...
    setup() {
        const BOOK_OUT_LIST_APP_STORE_MODULE_NAME = "book-out-list";

        // Register module
        if (!store.hasModule(BOOK_OUT_LIST_APP_STORE_MODULE_NAME))
            store.registerModule(
                BOOK_OUT_LIST_APP_STORE_MODULE_NAME,
                bookOutStoreModule
            );
        ...
        onUnmounted(() => {
            if (store.hasModule(BOOK_OUT_LIST_APP_STORE_MODULE_NAME))
                store.unregisterModule(BOOK_OUT_LIST_APP_STORE_MODULE_NAME);
        });
